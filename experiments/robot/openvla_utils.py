...
def get_processor(cfg: Any) -> AutoProcessor:
    ...
    """
    return PrismaticProcessor.from_pretrained(cfg.pretrained_checkpoint, trust_remote_code=True)
...
def get_noisy_action_projector(cfg: Any, llm_dim: int) -> NoisyActionProjector:
    ...
    noisy_action_projector = noisy_action_projector.to(torch.bfloat16)
